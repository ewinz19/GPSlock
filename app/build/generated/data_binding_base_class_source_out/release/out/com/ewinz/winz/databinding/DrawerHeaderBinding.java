...
public final class DrawerHeaderBinding implements ViewBinding {
  ...
  private DrawerHeaderBinding(@NonNull LinearLayout rootView, @NonNull Button button1,
      @NonNull Button button2, @NonNull Button button3, @NonNull Button button4,
      @NonNull Button button5, @NonNull EditText distanceInput, @NonNull TextView headerText,
      @NonNull EditText intervalInput) {
  ...
  public static DrawerHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DrawerHeaderBinding((LinearLayout) rootView, button1, button2, button3, button4,
          button5, distanceInput, headerText, intervalInput);
    }
